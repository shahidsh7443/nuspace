    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'desc' => __('First you select the "text" tab, then you add the html code.', 'archi'),
                'default' => '',
            ),        
            array(
                'id' => 'topbar_col_left',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'subtitle' => esc_html__('Pick the header static background color for the theme (default: rgba(0,0,0,0.5)), You need to be sure select Header Style is Header Customize before custom the colours.', 'archi'),
                'default' => '',
                'validate' => 'color',
            ),                    
            array(
                ...
                'subtitle' => esc_html__('Pick the header scroll background color for the theme (default: #18191b), You need to be sure select Header Style is Header Customize before custom the colours.', 'archi'),
                'default' => '#18191b',
                'validate' => 'color',
            ),
            array(
                ...
                'subtitle' => esc_html__('Pick the header scroll Border Bottom color for the theme (default: #333333), You need to be sure select Header Style is Header Customize before custom the colours.', 'archi'),
                'default' => '#333333',
                'validate' => 'color',
            ),                    
            array(
                ...
                'subtitle' => esc_html__('Pick the header static text color for the theme (default: #fff), You need to be sure select Header Style is Header Customize before custom the colours.', 'archi'),
                'default' => '',
                'validate' => 'color',
            ),  
            array(
                ...
                'subtitle' => esc_html__('Pick the header scroll text color for the theme (default: #606060), You need to be sure select Header Style is Header Customize before custom the colours.', 'archi'),
                'default' => '',
                'validate' => 'color',
            ),   
            array(
                ...
                'subtitle' => esc_html__('Pick the header menu item active and hover color for the theme (default: use main color follow the theme), You need to be sure select Header Style is Header Customize before custom the colours.', 'archi'),
                'default' => '',
                'validate' => 'color',
            ),          
            array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'description' => esc_html__('HTML code: <li><a target="_blank" href="#"><i class="fa fa-facebook"></i></a></li> , find more icons: http://fontawesome.io/icons/#brand', 'archi'),
                'default' => '',
            ),             
        )
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(            
            ...
            array(
                ...
                'subtitle' => esc_html__('Add Contact Form Shortcode', 'archi'),
                'desc' => esc_html__('Go to your contact form 7 to copy shortcode and paste your shortcode here, Ex: [contact-form-7 id="283" title="Contact form 1"]', 'archi'),
                'default' => '',
            ),                                   
        )    
    ) );
